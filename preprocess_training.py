...
def preprocess_for_training(train_A_dir, train_B_dir, cache_folder):
    ...
    frame_period = 5.0
    n_frames = 128
    print ('using {} sample rate'.format(sampling_rate))
    ...
    coded_sps_A_norm, coded_sps_A_mean, coded_sps_A_std = preprocess.coded_sps_normalization_fit_transoform(
        coded_sps=coded_sps_A_transposed)
    coded_sps_B_norm, coded_sps_B_mean, coded_sps_B_std = preprocess.coded_sps_normalization_fit_transoform(
...
if __name__ == '__main__':
    ...
    cache_folder_default = './cache_check_podcast_nas_44k/'
